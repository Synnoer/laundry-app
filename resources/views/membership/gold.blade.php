<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-amber-300 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <h2 class="font-size: 3rem">Gold Membership</h1>
                    <p>Rp. 100.000/month</p>
                </div>
            </div>
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <p>1. Membership duration 4 weeks</p>
                <p>2. Total weight each session 3 Kg</p>
                <p>3. Total session 8</p>
                <p>4. Available Service: Dry cleaning + fold + ironing</p>    
            </div>
            <div class="text-center mb-12">  
                <a href="https://wa.me/+6282321568554?text=Im%20interested%20in%20buying%20the%20Gold%20membership%20" 

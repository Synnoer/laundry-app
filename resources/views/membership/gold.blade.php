<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-gradient-to-r from-amber-200 to-amber-400 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <h2 class="text-3xl font-bold">Gold Membership</h2>
